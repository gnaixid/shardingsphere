...
public final class LogbackConfiguration extends BasicConfigurator {
    ...
    private void initBasicLogger(final LoggerContext loggerContext) {
        ...
        loggerContext.getLogger("org.apache.shardingsphere.infra.exception.generic").setLevel(Level.INFO);
        loggerContext.getLogger("org.apache.shardingsphere.infra.binder.context.statement.dml").setLevel(Level.INFO);
